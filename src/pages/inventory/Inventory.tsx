...
import { FilterComponent } from "@/components/ui/table/FilterComponent";
...
import { SelectColumnsComponent, TableComponent, type ColumnDef } from "@/components/ui/table/TableComponent";
            ...
            <div className="rounded-xl bg-white p-4">
                <div className="w-full flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button variant="primary"><IoMdAdd /> Agregar Producto</Button>
                    </div>
                </div>
