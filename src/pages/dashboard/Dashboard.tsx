            ...
            {dashboard && (
                <>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="bg-white rounded-xl p-4 border border-gray-200">
                            <p className="text-sm text-gray-600">Total de despachos</p>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                        ...
                        <div className="bg-white rounded-xl p-4 border border-gray-200">
                            <h3 className="text-lg font-bold mb-3 text-blue-800">Despachos</h3>
                            ...
                            <div className="space-y-2 h-104 overflow-y-auto pr-2">
                                {dashboard.frequentCustomers.map((customer) => (
                                    <div key={customer.customerId} className="flex items-center justify-between border-b border-gray-100 pb-2">
                                        ...
                                        <p className="text-sm font-semibold">{customer.totalInvoices} despachos</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                                ...
                                {dashboard.topProducts.map((product) => (
                                    <div key={product.productId} className="flex items-center justify-between border-b border-gray-100 pb-2">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">{product.totalQuantitySold} unidades | {product.totalInvoices} despachos</p>
                                        </div>
