import type { DeleteProductPayload, ExchangeRateBody, Product, ProductBody } from "@/interfaces/inventory.interface";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { breakDownProductApi, createProductApi, deleteProductApi, getExchangeRateAutomaticApi, getExchangeRateTodayApi, getInventoryApi, getInventoryHistoryApi, getSuggestionAttributesApi, postExchangeRateApi, putExchangeRateDefaultApi, updateProductApi, validatePasswordAdminApi } from "@/services/inventory.service";
